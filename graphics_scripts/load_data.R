...
# Dubosson2018_data[[1]] <- c(Dubosson2018_df[1:59, ], manual=52, gap=0, short=1, dtype=1, adult=1)
# Dubosson2018_data[[2]] <- c(Dubosson2018_df[60:352, ], manual=118, gap=0, short=0, dtype=1, adult=1)
# Dubosson2018_data[[3]] <- c(Dubosson2018_df[353:645, ], manual=264, gap=0, short=0, dtype=1, adult=1)
# Dubosson2018_data[[4]] <- c(Dubosson2018_df[646:939, ], manual=183, gap=0, short=0, dtype=1, adult=1)
# Dubosson2018_data[[5]] <- c(Dubosson2018_df[940:1233,],manual=150.33, gap=0, short=0, dtype=1, adult=1)
# 
# # HALL DATASET
...
# Hall2018_data <- list()
# 
# # Subject 1636-69-001 in dataset
# Hall2018_data[[1]] <- c(Hall2018_df[1:244,    ], manual=30.6 , gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[2]] <- c(Hall2018_df[245:531,  ], manual=106.6, gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[3]] <- c(Hall2018_df[532:754,  ], manual=83   , gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[4]] <- c(Hall2018_df[755:849,  ], manual=91   , gap=1, short=0, adult=1, dtype=0)
# Hall2018_data[[5]] <- c(Hall2018_df[849:1101, ], manual=57.67, gap=0, short=0, adult=1, dtype=0) # microscopic gap
# 
# # Subject 1636-69-001(026) in dataset
# Hall2018_data[[6]] <-  c(Hall2018_df[1102:1379, ], manual=50.6 , gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[7]] <-  c(Hall2018_df[1380:1666, ], manual=56.6 , gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[8]] <-  c(Hall2018_df[1667:1846, ], manual=34.33, gap=0, short=0, adult=1, dtype=0) # Has a small gap
# Hall2018_data[[9]] <-  c(Hall2018_df[1847:2124, ], manual=53   , gap=0, short=0, adult=1, dtype=0)
# Hall2018_data[[10]] <- c(Hall2018_df[2125:2303, ], manual=65   , gap=1, short=0, adult=1, dtype=0)
# Hall2018_data[[11]] <- c(Hall2018_df[2304:2585, ], manual=47.33, gap=0, short=0, adult=1, dtype=0) # Has microscopic gap
# 
# # subject 035 in dataset
# Hall2018_data[[12]] <- c(Hall2018_df[7697:7953, ], manual=51.67, gap=1, short=0, adult=1, dtype=0) # has number of small gaps
# Hall2018_data[[13]] <- c(Hall2018_df[7954:8128, ], manual=74.5 , gap=1, short=0, adult=1, dtype=0)
# Hall2018_data[[14]] <- c(Hall2018_df[8129:8343, ], manual=46   , gap=1, short=0, adult=1, dtype=0)
# Hall2018_data[[15]] <- c(Hall2018_df[8344:8513, ], manual=40   , gap=1, short=0, adult=1, dtype=0)
# Hall2018_data[[16]] <- c(Hall2018_df[8514:8745, ], manual=61   , gap=1, short=0, adult=1, dtype=0)
# 
...
# 
# # Subject 7 in dataset
# Tsalikian2005_data[[1]] <- c(Tsalikian2005_df[1:135,   ], manual=144, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[2]] <- c(Tsalikian2005_df[136:242, ], manual=95.5, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[3]] <- c(Tsalikian2005_df[243:384, ], manual=135, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[4]] <- c(Tsalikian2005_df[385:455, ], manual=14.5, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[5]] <- c(Tsalikian2005_df[456:561, ], manual=45, gap=0, short=1, adult=0, dtype=1)
# 
# 
# Tsalikian2005_data[[6]] <-  c(Tsalikian2005_df[1601:1755, ], manual=68.5, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[7]] <-  c(Tsalikian2005_df[3076:3230, ], manual=87.33, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[8]] <-  c(Tsalikian2005_df[3319:3475, ], manual=360, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[9]] <-  c(Tsalikian2005_df[3549:3701, ], manual=105.33, gap=0, short=1, adult=0, dtype=1)
# Tsalikian2005_data[[10]] <- c(Tsalikian2005_df[4272:4423, ], manual=283, gap=0, short=1, adult=0, dtype=1)
# 
# ## RESULT ##
