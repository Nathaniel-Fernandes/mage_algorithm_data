...
plot_data <- list()
plot_data[[1]] <- datafile[1102:1379, ]
plot_data[[2]] <- datafile[1380:1666, ]
plot_data[[3]] <- datafile[1667:1846, ]
plot_data[[4]] <- datafile[1847:2124, ]
plot_data[[5]] <- datafile[2125:2303, ]
plot_data[[6]] <- datafile[2304:2585, ]
