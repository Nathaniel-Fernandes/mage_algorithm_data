...
plot_data <- list()
plot_data[[1]] <- datafile[7697:7953, ]
plot_data[[2]] <- datafile[7954:8128, ]
plot_data[[3]] <- datafile[8129:8343, ]
plot_data[[4]] <- datafile[8344:8513, ]
plot_data[[5]] <- datafile[8514:8745, ]
